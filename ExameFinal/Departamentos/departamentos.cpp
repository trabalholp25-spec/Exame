...
Departamento CriarDepartamento() {
    ...
    printf(
        "ID: %d | Nome: %s | Responsável: %s | Email: %s | Telefone: %s | Estado: %d\n",d.IdDept, d.nome, d.responsavel, d.email, d.telefone, EstadoParaTexto(d.estado));
    ...
    fprintf(f, "%d;%s;%s;%s;%s;%d;\n",d.IdDept, d.nome, d.responsavel,  d.email, d.telefone, d.estado);
