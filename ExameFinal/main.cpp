            ...
            case 5: // Relatórios
                ...
                switch (escolha2) {
                    ...
                    case 2: // Administração dos Departamentos
                        ...
                        switch (escolha3) {
                            case 1:
                                total = DepartamentosExistentes();
                                printf ("Existe %d Departamentos registados!\n", total);
                                break;
                            case 2:
                                ListarDepartamentos();
                                break;
                            case 3:
                                OrdenarDepartamentosPorOrdens();
                                break;
                            case 0:
                                break;
                        }
                    ...
                    case 4:
                        ...
                        switch (escolha3) {
                            case 1:
                                ...
                                switch (escolha4) {
                                    case 1:
                                        ListarTecnicosPorCategoria();
                                        break;
                                    case 2:
                                        ListarTecnicosPorDisp();
                                        break;
                                    case 0:
                                        break;
                                }
